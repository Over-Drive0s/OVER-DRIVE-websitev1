...
export type SocialAuthProvider = 'google' | 'apple' | 'slack'
    ...
    <div className="overflow-hidden rounded-md border border-white/[0.08]">
      {providers.map(({ id, label, Icon }, index) => (
        <button
          ...
          className={`group flex w-full items-center justify-center gap-2.5 bg-[#080a0e]/50 px-3 py-2.5 text-sm font-medium text-white transition-colors duration-200 hover:bg-[#0080ff]/[0.06] active:bg-[#0080ff]/10 ${
